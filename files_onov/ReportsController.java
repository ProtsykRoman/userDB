...
public class ReportsController {
    ...
    public void exportToExcel(
        ...
        boolean hasAccess = report.stream()
                .anyMatch(r -> r.getSource() == ua.com.userdb.dto.ReportSourceType.ACCESS);

        boolean hasCertificate = report.stream()
                .anyMatch(r -> r.getSource() == ua.com.userdb.dto.ReportSourceType.CERTIFICATE);
